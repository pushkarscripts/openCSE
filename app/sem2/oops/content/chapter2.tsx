    ...
    <div className="course-content">
      ...
      <section>
        ...
        <ul className="section-list">
          <li>
            <strong>Encapsulation</strong> – grouping data and methods inside a class
          </li>
          <li>
            <strong>Abstraction</strong> – exposing only essential features
          </li>
          <li>
            <strong>Inheritance</strong> – reusing existing classes
          </li>
          <li>
            <strong>Polymorphism</strong> – performing actions differently
          </li>
        </ul>
      ...
      <section>
        ...
        <p className="p-text">
          ...
          created using the{" "}
          <code className="inline-code">new</code> keyword.
        </p>
...
s.show();`}
        ...
        <p className="p-text mt-3">
          Diagram: <strong>class-object-diagram.png</strong>
        </p>
      </section>
...
Point p2 = new Point(5, 8);`}
        ...
        <p className="p-text mt-3">
          ...
          <strong>try-with-resources</strong> and garbage collection.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="section-list">
          ...
          <li>
            <strong>protected</strong> – class + subclasses + same package
          </li>
          <li>
            <strong>default</strong> – class + same package
          </li>
        </ul>
    ...
    return id;
      ...
      <section>
        ...
        <p className="p-text">
          ...
          <code className="inline-code">this</code> keyword refers to the
          current object.
        </p>
...
sb.append("CSE");`}
        ...
        <p className="p-text mt-3">
          Diagram: <strong>string-immutability.png</strong>
        </p>
      </section>
