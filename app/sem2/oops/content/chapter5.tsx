...
export const Ch5Content = () => {
    ...
    <div className="course-content">
      ...
      <section>
        ...
        <ul className="section-list">
          <li>
            <strong>Exception</strong> – indicates runtime errors that can
            be handled
          </li>

          <li>
            <strong>Error</strong> – serious issues not expected to be
            handled
          </li>

          <li>
            All exceptions derive from the class{" "}
            <code className="inline-code">Throwable</code>
          </li>
        </ul>
        ...
        <p className="p-text mt-2">
          Diagram: <strong>exception-hierarchy.png</strong>
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="section-list">
          <li>
            <strong>Checked exceptions</strong> – must be caught or declared
          </li>

          <li>
            <strong>Unchecked exceptions</strong> – inherit from
            RuntimeException
          </li>

          <li>
            <strong>Errors</strong> – not meant to be handled
          </li>
        </ul>
        ...
        <div className="example-box bg-[#f3e7c2] border border-[#c7a669] p-4 rounded-lg mt-4">
          ...
          <CodeBlock
            code={`int x = 10 / 0;   // ArithmeticException`}
          />
        </div>
        ...
        <div className="example-box bg-[#f0ddb6] border border-[#c7a669] p-4 rounded-lg mt-4">
          ...
          <CodeBlock
            code={`FileReader fr = new FileReader("abc.txt");`}
          />
        </div>
      </section>
      ...
      <section>
        ...
        <p className="p-text">
          A <strong>try block</strong> contains statements that may throw an
          exception. <strong>catch blocks</strong> handle specific exception
          types. The <strong>finally block</strong> executes whether or not
          an exception occurs.
        </p>
  ...
  System.out.println("Cleanup operations");
        ...
        <ul className="section-list mt-4">
          ...
          <li>
            <code className="inline-code">finally</code> is often used to
      ...
      <section>
        ...
        <p className="p-text">
          ...
          <strong>throws</strong> declares that a method may throw an
          exception.
        </p>
  ...
  FileReader f = new FileReader("data.txt");
      ...
      <section>
        ...
        <p className="p-text">
          ...
          <code className="inline-code">Exception</code> class.
        </p>
    ...
    throw new InvalidMarksException("Invalid marks");
      ...
      <section>
        ...
        <p className="p-text">
          ...
          <strong>try-catch-finally</strong>, throwing exceptions, and
        ...
        <p className="p-text mt-4">
          Diagrams to insert:{" "}
          <strong>try-catch-flowchart.png</strong>,{" "}
          <strong>exception-types-table.png</strong>
        </p>
      </section>
