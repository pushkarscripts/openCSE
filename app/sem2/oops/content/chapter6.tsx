    ...
    <div className="course-content">
      ...
      <section>
        ...
        <ul className="section-list">
          ...
          <li>
            <strong>Multithreading</strong> – executing multiple threads
          </li>
          <li>
            <strong>Context switching</strong> – CPU switching between threads
          </li>
        </ul>
  ...
  public static void main(String[] args) {
    ...
    System.out.println(t.getPriority());
      ...
      <section>
        ...
        <ul className="section-list">
          <li>
            Extending the <strong>Thread</strong> class
          </li>

          <li>
            Implementing the <strong>Runnable</strong> interface
          </li>
        </ul>
  ...
  synchronized void increment() {
    ...
    count++;
      ...
      <section>
        ...
        <p className="p-text">
          Java provides <strong>wait()</strong>,
          <strong> notify()</strong>, and
          <strong> notifyAll()</strong> for threads to communicate inside
          synchronized blocks.
        </p>
  ...
  obj.notify();
      ...
      <section>
        ...
        <p className="p-text mt-4">
          Add diagrams: <strong>thread-cycle.png</strong>,
          <strong> synchronization-flow.png</strong>
        </p>
      </section>
